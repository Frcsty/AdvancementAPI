...
public final class NameKey {
    ...
    /**
     * @param key The key inside the default namespace "minecraft" or a NameSpacedKey separated by :
     */
    public NameKey(final String key) {
     ...
     *
     * @param from minecraft key
     */
    public NameKey(final MinecraftKey from) {
     ...
     */
    public boolean isSimilar(final NameKey anotherNameKey) {
